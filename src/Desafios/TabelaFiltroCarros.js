...
export default function TabelaFiltroCarros () {
    const carros=[
        {categoria:"Esporte", preco:"110000", modelo:"Gold GTI"},
      ...
      const linhas=(cat)=>{
        ...
        carros.forEach(
          (carro)=>{
          if(carro.categoria.toUpperCase().includes(cat.toUpperCase()) || cat.toUpperCase() == '')
          {
            li.push(
            <tr>
